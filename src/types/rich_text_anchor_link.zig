...
type: enums.RichTextType = .anchor_link,
...
pub fn jsonParseFromValue(allocator: std.mem.Allocator, value: std.json.Value, options: std.json.ParseOptions) !@This() {
    return .{
        ...
        .anchor_name = try std.json.innerParseFromValue([]const u8, allocator, value.object.get("anchor_name") orelse return error.MissingField, options),
    };
}
