...
type: enums.RichTextType = .cashtag,
...
pub fn jsonParseFromValue(allocator: std.mem.Allocator, value: std.json.Value, options: std.json.ParseOptions) !@This() {
    return .{
        ...
        .cashtag = try std.json.innerParseFromValue([]const u8, allocator, value.object.get("cashtag") orelse return error.MissingField, options),
    };
}
