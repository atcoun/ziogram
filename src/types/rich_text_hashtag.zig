...
type: enums.RichTextType = .hashtag,
...
pub fn jsonParseFromValue(allocator: std.mem.Allocator, value: std.json.Value, options: std.json.ParseOptions) !@This() {
    return .{
        ...
        .hashtag = try std.json.innerParseFromValue([]const u8, allocator, value.object.get("hashtag") orelse return error.MissingField, options),
    };
}
