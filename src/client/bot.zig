...
pub fn promoteChatMember(
    ...
    options: struct {
        ...
        can_send_welcome_messages: ?bool = null,
        request_timeout: ?i32 = null,
    },
) !bool {
    return self.call(
        ...
        methods.PromoteChatMember{
            ...
            .can_send_welcome_messages = options.can_send_welcome_messages,
        },
        options.request_timeout,
    );
}
...
pub fn sendAnimation(
    ...
    options: struct {
        ...
        message_thread_id: ?i32 = null,
        direct_messages_topic_id: ?i32 = null,
        ephemeral_message_parameters: ?types.EphemeralMessageParameters = null,
        duration: ?i32 = null,
        width: ?i32 = null,
        height: ?i32 = null,
    ...
    return self.call(
        ...
        methods.SendAnimation{
            ...
            .message_thread_id = options.message_thread_id,
            .direct_messages_topic_id = options.direct_messages_topic_id,
            .ephemeral_message_parameters = options.ephemeral_message_parameters,
...
pub fn sendMessageDraft(
    ...
    return self.call(
        ...
        methods.SendMessageDraft{
            ...
            .parse_mode = options.parse_mode,
            .entities = options.entities,
            .can_stop = options.can_stop,
            .keep_on_stop = options.keep_on_stop,
        },
        options.request_timeout,
    );
}
